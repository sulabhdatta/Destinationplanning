<?php include_once './phpcode/Login_issue_php.php';
?>
<!DOCTYPE html>
<html>
    <head>
...
box-shadow: 3px 6px 19px 0px rgba(0,0,0,0.75);
    ...
    <div class="container-fluid">
                <center><span style="color:black;background-color:white;font-size:35px;border-radius:5px;font-family:'Fugaz One';text-shadow:2px 2px 2px red"> Login Related Issue </span></center>
        ...
        <div class="row">
            ...
            <div  class="col-lg-4" style='margin-top:-15px;'>
                <div  id="formp" class="form-group">
                    <form method="post">
                        <br>
                        <input type="email" name="mail" class="form-control" style="font-family:'Fugaz One'"; placeholder="Enter your mail-id" required/> <br>
                        <textarea name="t" id='textarea' rows="10" cols="40" style="font-family:'Fugaz One'";  placeholder="Query :" required></textarea>
