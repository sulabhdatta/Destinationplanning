<?php include_once './phpcode/Payment_issue_php.php';
?>
<!DOCTYPE html>
<html>
    <head>
...
box-shadow: 3px 6px 19px 0px rgba(0,0,0,0.75);
    ...
    <div class="container-fluid">
        <center><span style="color:black;background-color:white;font-size:35px;border-radius:5px;font-family:'Fugaz One';text-shadow:2px 2px 2px greenyellow";> Payment Related Issue </span></center>
        <div class="row">
