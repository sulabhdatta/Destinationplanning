...
box-shadow: 3px 6px 19px 0px rgba(0,0,0,0.75);
    ...
    <div class="container-fluid">
                <center><span style="color:black;background-color:white;font-size:35px;border-radius:5px;font-family:'Fugaz One';text-shadow:2px 2px 2px lightseagreen";> Package Related Issue </span></center>
        ...
        <div class="row">
            ...
            <div  class="col-lg-4" style='margin-top:-15px;'>
                <div  id="formp" class="form-group">
                    <form>
                        <br>
                        <input type="email" class="form-control" placeholder=" * Enter your mail-id" style="font-family:'Fugaz One'"; required/> <br>
                        <textarea name="t" id='textarea' rows="10" cols="40" placeholder="Query:" style="font-family:'Fugaz One'"; required></textarea>
                        <input type="submit" class="btn btn-success" value="submit" style="font-family:'Fugaz One'";/>
                    </form>
                </div>
