...
<?php
include_once './phpcode/forgetuserid.php'
?>
<!DOCTYPE html>
                ...
                <div class="col-lg-4 col-12">
                    ...
                    <div  class="form-group">
                        <form method="post">
                            ...
                            <br>  <input type="number" name="number" maxlength="10" class="form-control" placeholder="Mobile number" style="font-family: 'Fugaz One'"; required><br>
